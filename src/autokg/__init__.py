...
from ._plugin import (
    register_connector as register_plugin_connector,
...
from ._types import (
    XSD, RDF, RDFS, OWL, SCHEMA, DCAT, DCTERMS, PROV, FOAF, SKOS,
    resolve_prefix, resolve_auto_map, infer_xsd_type,
    detect_primary_key, sanitize_name,
)
...
__all__ = [
    ...
    "RelationshipInference", "CatalogGenerator",
    "serialize_triples", "push_to_sparql_endpoint", "write_triples",
